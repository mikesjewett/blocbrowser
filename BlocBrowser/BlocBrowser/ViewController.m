...
- (void) displayWelcomeMessage {
    ...
    UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Welcome to BlocBrowser" message:@"Tap OK to browse securely." preferredStyle:UIAlertControllerStyleAlert];
